...
Partial Class Dashboard
    ...
    Private Sub InitializeComponent()
        ...
        CType(picGuide, ComponentModel.ISupportInitialize).BeginInit()
        SuspendLayout()
        ' 
        ' pnlSidebar
        ' 
        ...
        pnlSchoolYear.Location = New Point(0, 204)
        ...
        pnlSchoolYearIndicator.Location = New Point(0, 2)
        ...
        pnlBatchesMenu.Location = New Point(0, 261)
        ...
        lblBatches.Location = New Point(50, 5)
        ...
        pnlSubjectsMenu.Location = New Point(-1, 320)
        ...
        pnlStudentsMenu.Location = New Point(2, 382)
        ...
        pnlTopbar.Controls.Add(pnlGuide)
        ...
        ' pnlGuide
        ' 
        pnlGuide.BackColor = Color.FromArgb(CByte(139), CByte(92), CByte(246))
        pnlGuide.Controls.Add(lblGuide)
        pnlGuide.Controls.Add(picGuide)
        pnlGuide.Cursor = Cursors.Hand
        pnlGuide.Location = New Point(1200, 14)
        pnlGuide.Name = "pnlGuide"
        pnlGuide.Size = New Size(138, 42)
        pnlGuide.TabIndex = 8
        ' 
        ' lblGuide
        ' 
        lblGuide.AutoSize = True
        lblGuide.Font = New Font("Poppins", 9.75F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        lblGuide.ForeColor = Color.White
        lblGuide.Location = New Point(34, 10)
        lblGuide.Name = "lblGuide"
        lblGuide.Size = New Size(95, 23)
        lblGuide.TabIndex = 5
        lblGuide.Text = "Set Up Guide"
        ' 
        ' picGuide
        ' 
        picGuide.Image = CType(resources.GetObject("picGuide.Image"), Image)
        picGuide.Location = New Point(6, 11)
        picGuide.Name = "picGuide"
        picGuide.Size = New Size(23, 19)
        ...
        CType(picGuide, ComponentModel.ISupportInitialize).EndInit()
        ResumeLayout(False)
    End Sub
    ...
    Friend WithEvents pnlGuide As RoundedPanel4
    Friend WithEvents lblGuide As Label
    Friend WithEvents picGuide As PictureBox
