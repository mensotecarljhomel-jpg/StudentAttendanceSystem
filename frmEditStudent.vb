...
Public Class frmEditStudent
    ...
    Private Sub InitializeUI()
        ...
        picIcon.Location = New Point(101, -1)
        ...
        lblTitle.Location = New Point(160, 100)
        ...
        lblSubtitle.Text = "Update an existing student's information"
    ...
    Private Sub LoadStudent()
        ...
        Try
            ...
            Dim cmd As New MySqlCommand(
                "SELECT student_number, first_name, last_name, gender, batch_id " &
                "FROM students " &
            ...
            If reader.Read() Then
                ...
                Dim batchCmd As New MySqlCommand(
                    "SELECT batch_name FROM batches WHERE batch_id=@batch_id",
                    Connection
                )
                ...
                Dim batchName As Object =
                    batchCmd.ExecuteScalar()

                If batchName IsNot Nothing Then

                    cboSection.Text = batchName.ToString()
    ...
    e As EventArgs
        ...
        Try
            ...
            If txtStudentNumber.Text.Trim <> StudentNumber Then
